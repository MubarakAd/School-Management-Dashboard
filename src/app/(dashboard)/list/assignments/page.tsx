...
import { role,  assignmentsData} from "@/data/data";
import { column } from "@/data/assigmentsHeaderData";
...
const page = () => {
  return (
    <div className="p-4 bg-white m-3 rounded-md">
      <CommonHeader career="All Assignments" />
      <DataTable data={assignmentsData} columns={column} render={render} />
    </div>
  );
};
