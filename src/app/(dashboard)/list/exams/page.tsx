...
import { role, examsData} from "@/data/data";
import { column } from "@/data/examsHeaderData";
...
const page = () => {
  return (
    <div className="p-4 bg-white m-3 rounded-md">
      <CommonHeader career="All Exams" />
      <DataTable data={examsData} columns={column} render={render} />
    </div>
  );
};
